...
\begin{winprop}{lazy_resize}{boolean}
    \index{lazy-resize@\var{lazy_resize}}
...
\var{instance}\index{instance@\var{instance}!winprop} of the window.
...
\var{is_dockapp}\index{is-dockapp@\var{is_dockapp}!winprop} fields, or a
...
\begin{center}
\begin{tabular}{lll}
  \tabhead{\var{class} & \var{role} & \var{instance}}
  E	       & E          & E \\
  E	       & E          & * \\
  E	       & *          & E \\
  E	       & *          & * \\
...
\subsubsection{Secondary filters}
...
named \var{match} to the winprop table. This function will be passed 3 
...
\var{is_transient}\index{is-transient@\var{is_transient}!winprop} and
\var{is_dockapp}\index{is-dockapp@\var{is_dockapp}!winprop} fields of the 
window.
...
To get class and instance, simply run \command{xprop WM_CLASS}
